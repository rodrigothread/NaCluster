...
public class ConnectionPool {
	...
	private void createConnectionParameters(String IRI) throws CatalogException {
		...
		try {
			...
			this.maxConnections = (Integer) catalogManager.getSingleObject("databases", "maxconnection",
					"iri='"+IRI+"'");
			this.url = (String) catalogManager.getSingleObject("databases", "host", "iri='"+IRI+"'");
			...
			this.user = (String) catalogManager.getSingleObject("databases", "username", "iri='"+IRI+"'");
			this.pwd = (String) catalogManager.getSingleObject("databases", "passwrd", "iri='"+IRI+"'");
			this.driverName = (String) catalogManager.getSingleObject("databases", "driverName", "iri='"+IRI+"'");
