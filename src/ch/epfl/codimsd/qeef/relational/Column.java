...
//	}
	...
	/**
     * Cria uma outra inst�ncia desta coluna id�ntica a esta.
     * 
     * @return Nova coluna.
     */
	public Object clone() {
		...
		if (sqlType == 0) {
			return new Column(name, type.newInstance(), size, position, key);
		} else
			return new Column(name, type.newInstance(), size, position, key, sqlType);
