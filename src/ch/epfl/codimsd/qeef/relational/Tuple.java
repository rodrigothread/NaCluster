...
import ch.epfl.codimsd.qeef.RelationalDataSource;
...
public class Tuple extends Instance implements Serializable {
	...
	/**
	 * Atribui valor a primeira coluna que n�o possuir valor. 
	 * It attributes to value the first column that do not possess a value. 
	 * @param value Valor a ser atrubu�do a prrimeira coluna sem valor. 
	 */
	...
	/**
	 * Obtem o valor da coluna que ocupa a n-�sima posi��o.
	 * @param nth Posi��o ocupada pela coluna que se deseja saber o valor.
	...
	public String toString(){
	    ...
	    for(int i=0; i < values.size(); i++){
	        ...
	        out += ((Type)values.get(i)).toString() + " ; ";
	    }
